...
public class WhitelistAdapter extends ArrayAdapter<String> {
    ...
    static class WhitelistViewHolder {
        public TextView text1;
        public TextView text2;
    }

    public WhitelistAdapter(Activity context, int resource, String[] items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItem == null) {
            ...
            WhitelistViewHolder viewHolder = new WhitelistViewHolder();
        ...
        // fill data
        WhitelistViewHolder viewHolder = (WhitelistViewHolder) listItem.getTag();
